...
class PhongMaterial {
    public:
        PhongMaterial(double a, double d, double s, double h, double r, Color a_c, Color d_c, Color s_c);
        PhongMaterial();
        ...
        void set_reflectiveness(double a);
        void set_envir_color(Color c);
        void set_diffuse_color(Color c);
        void set_specular_color(Color c);
    private:
        double envir_factor, diffuse_factor, specular_factor, highlight_factor, reflectiveness;
